...
const PLANNED_EVIDENCE: EvidenceView = {
  ...
  // Every track the case holds, the untouched ones included. The drawer's answer to "how do
  // you know the others were left alone" is that they are in the record with nothing against
  // their name, so a fixture that carried only the interesting ones would not test the claim.
  tracks: [
    {
      promise_id: 'pr-a',
      track_id: 'track-pr-a',
    ...
    },
    {
      ...
      fingerprint: 'fp-b1122334455667788',
      order_external_id: 'EXT-B',
      order_external_version: 1,
      mirrored_versions: { 'ol-b': 'rv-raspberry-tart-2' },
      paths: 1,
      watched_entities: 3,
      effects: [],
      escalation_reason: null,
    ...
    },
    {
      ...
      rule_id: 'R-NOSUB',
      reason_detail: 'NOSUB_CONSTRAINT',
      fingerprint: null,
      order_external_id: 'EXT-C',
      order_external_version: 1,
      mirrored_versions: { 'ol-c': 'rv-wedding-tier-4' },
      paths: 1,
      watched_entities: 2,
      effects: [],
      escalation_reason: null,
    ...
    },
    {
      ...
      reason_detail: 'NOT_REACHABLE',
      fingerprint: null,
      order_external_id: 'EXT-F',
      order_external_version: 1,
      mirrored_versions: { 'ol-f': 'rv-sourdough-batard-1' },
      paths: 0,
      watched_entities: 0,
      effects: [],
      escalation_reason: null,
...
export const PLANNED_CASE: CaseWorkspaceResponse = {
  ...
  exception_category: 'SUPPLY_NOT_RECEIVED',
  exception_phrase: 'a supplier delivery did not arrive',
